    ...
    <div class="row ">
      ...
      <div class="col-md-2 mx-auto">
        ...
        <ul class="list-unstyled ">
          ...
          <li class="my-2">
            <a href="shop.html" class="text-white ">Event Hosting</a>
          </li>
        </ul>
      </div>
      ...
      <div class="col-md-3 mx-auto ">
        ...
        <ul class="list-unstyled ">
          <li class="my-2 ">
            <a href="#contact">
              <i class="fas fa-home mr-2 text-white ">No 21, Adeniji Street, S/L. Lagos</i style="color: yellow; ">
            </a>
          </li>
          <li class="my-2 ">
            <a href="#">
          ...
          <li class="my-2 ">
            <a href="#">
              <i class="fas fa-phone mr-2 text-white "></i> <i style="color: yellow; ">+2348102108628</i>
            </a>
          </li>
          <li class="my-2 ">
            <a href="#">
              <i class="fas fa-tty mr-2 text-white "></i> <i style="color: yellow; "> +01 543 214 098</i>
            </a>
          </li>
        </ul>
      </div>
